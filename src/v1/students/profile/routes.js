const { addProfile, getProfile, getProfileDetails, updateProfileImage, studentSortByClassName, generatePdfForStudent,  } = require("./controller");
...
module.exports = (app) => {
    ...
    app.post("/v1/userImage",  updateProfileImage)
    app.get("/v1/studentGetByClassName", studentSortByClassName)
  app.get("/pdf-genrate/:userId",generatePdfForStudent)
}
